...
export const CAREERS: CareerProps[] = [
  ...
  {
    position: "NVIDIA Mentorship Program Participant",
    company: "NVIDIA",
    ...
    responsibilities: [
      ...
      "Had the privilege of getting personally mentored by top level engineers at Nvidia, especially Mr. Ken Okada",
    ],
    isShow: true,
  },
];
